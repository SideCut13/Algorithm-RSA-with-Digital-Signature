...
public class PanelInstructionRSA extends JPanel {
    ...
    private JTextArea taInstruction = new JTextArea("• RSA contains public and private key.\n" +
            "• Fist of all we must generate two prime numbers: p and q.\n" +
            "• Then we must multiply them and the result\n    is product n which is from formula: n = p·q.\n" +
